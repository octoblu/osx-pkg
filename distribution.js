...
function createDistributionXml(opts, pkgs) {
  ...
  var distribution = {
    "installer-script": [
      ...
      { domains: { _attr: { enable_anywhere: "true", enable_currentUserHome: "true", enable_localSystem: "true" } } },
      {
  ...
  pkgs.forEach(function(pkg) {
    distribution["installer-script"].push({
      choice: [
        { _attr: { id: pkg.dir, title: pkg.title } },
        {
          "pkg-ref": [{ _attr: { id: pkg.identifier, installKBytes: pkg.installKBytes, version: pkg.version, auth: "None" } }, "#" + pkg.dir],
        },
      ],
    })
  })
